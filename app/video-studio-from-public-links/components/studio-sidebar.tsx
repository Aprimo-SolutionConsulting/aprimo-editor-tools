...
import {
  Copy, Check, ExternalLink, FolderOpen, X, Clapperboard, Film, Music2, ImageIcon, Type,
          ...
          <div className="flex-1 overflow-auto">
            ...
            {assets.map((asset) => (
              <div
                ...
                className={`flex items-center gap-2 px-3 py-2 border-b border-border group cursor-grab active:cursor-grabbing ${draggingId === asset.id ? "opacity-50" : ""} ${
